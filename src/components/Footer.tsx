...
const Footer = () => {
  ...
  const categories = [
    { label: 'Sofa Sets', path: '/category/sofa-sets' },
    { label: 'Beds & Mattresses', path: '/category/beds-mattresses' },
  ...
  const socialMedia = [
    {
      name: 'Facebook',
      url: 'https://facebook.com/a1furniturestudio',
      icon: (
    ...
    {
      name: 'Instagram',
      url: 'https://instagram.com/a1furniturestudio',
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'Twitter',
      url: 'https://twitter.com/a1furniturestudio',
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
